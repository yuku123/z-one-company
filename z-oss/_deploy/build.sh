...
# ====================== 配置项（请根据你的项目修改）======================
PROJECT_NAME="z-oss"       # 项目名称（用于镜像/容器命名）
DOCKERFILE_PATH="./Dockerfile"      # Dockerfile 路径
IMAGE_NAME=":latest" # 镜像名称+标签
CONTAINER_NAME=""    # 容器名称
HOST_PORT=8088                      # 宿主机映射端口
CONTAINER_PORT=8088                 # 容器内端口（对应SpringBoot服务端口）
HEALTH_CHECK_URL="http://127.0.0.1:8088/actuator/health" # 健康检查接口（需开启SpringBoot Actuator）
