...
import com.zifang.util.db.meta.ColumnDTO;
import com.zifang.util.db.meta.DatabaseDTO;
import com.zifang.util.db.meta.TableDTO;
...
public class CodeGenerator {
    // 数据库配置
    private static final String DB_URL = "jdbc:mysql://101.37.80.51:3306/z_config?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8";
    private static final String DB_USER = "zifang";
    private static final String DB_PASS = "Hhzemol!123";
    private static final String DB_DRIVER = "com.mysql.cj.jdbc.Driver";

    // 生成配置
    private static final String BASE_PACKAGE = "com.zifang.z.config.core.domain";
    private static final String OUTPUT_DIR = "z-config-core/src/main/java";
    private static final String TEMPLATE_DIR = "template/mybait-plus-fortmat";
    ...
    private static DatabaseDTO getDatabaseMetaData() throws SQLException {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            try (ResultSet tableRs = metaData.getTables(dbName, null, "%", new String[]{"TABLE"})) {
                while (tableRs.next()) {
