...
#### 2.1.6 通用命令
- **键管理**: `KEYS`, `EXISTS`, `DEL`, `UNLINK`, `EXPIRE`, `PEXPIRE`, `TTL`, `PTTL`, `PERSIST`, `EXPIREAT`, `PEXPIREAT`, `TOUCH`, `RENAME`, `RENAMENX`
...
- **Stream**: `XADD`, `XREAD`, `XDEL`, `XRANGE`, `XREVRANGE`, `XLEN`, `XREADGROUP`, `XACK`, `XCLAIM`, `XPENDING`, `XGROUP`, `XINFO`, `XTRIM`
